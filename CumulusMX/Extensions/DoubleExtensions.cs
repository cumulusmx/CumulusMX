...
namespace CumulusMX
{
	...
	{
		/// <summary>
		/// Formats the specified double value as a string using the provided fixed-point format and invariant culture.
		/// </summary>
		...
		/// <returns>A string representation of the double value formatted according to the specified fixed-point format and using
		...
		/// <summary>
		/// Formats the specified nullable double value as a string using the provided format, or returns a default value if
		/// the input is null.
		/// </summary>
		/// <remarks>This method ensures that negative zero values are formatted as positive zero when using
		/// fixed-point formats (e.g., "F1", "F2"). The formatting uses invariant culture to ensure consistent results
		/// regardless of the current culture settings.</remarks>
		/// <param name="value">The nullable double value to format. If null, the method returns the value specified by the nullValue parameter.</param>
		...
		/// <returns>A string representation of the double value formatted according to the specified format, or the nullValue string
		...
		/// <summary>
		/// Converts the specified double value to its string representation using the given numeric format and the current
		...
		/// <returns>A string representation of the double value formatted according to the specified format and the current culture.
		...
		/// <summary>
		/// Formats the specified nullable double value as a string using the given numeric format and the current culture.
		...
		/// <param name="value">The nullable double value to format. If null, the method returns the value specified by <paramref
		...
		/// <returns>A string representation of the double value formatted according to the specified format and current culture, or
