...
namespace CumulusMX
{
	...
	internal class WebTags
	{
		...
		*/
		...
		{
			return CheckRC(station.SunshineHours.ToString(cumulus.SunFormat), TagParams);
		}
		...
		{
			return CheckRC(station.YestSunshineHours.ToString(cumulus.SunFormat), TagParams);
		}
