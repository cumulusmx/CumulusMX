	...
	internal class EcowittHttpApiStation : WeatherStation
	{
		...
		private bool GetHistoricDataSdCard()
		{
			...
			foreach (var rec in sortedData)
			{
				...
				MetData.TempSamplesToday += intervalMins;
				...
				CalculateDominantWindBearing(MetData.WindBearing, MetData.WindAverage, intervalMins);
				...
				AddRecentDataWithAq(DataDateTime);
