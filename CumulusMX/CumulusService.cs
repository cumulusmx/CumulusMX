		...
		protected override bool OnPowerEvent(PowerBroadcastStatus powerStatus)
		{
			switch (powerStatus)
			{
				...
				case PowerBroadcastStatus.PowerStatusChange:
					Program.cumulus.LogMessage("POWER: Detected system POWER STATUS CHANGE", Cumulus.LogLevel.Warning);
					break;
				case PowerBroadcastStatus.QuerySuspend:
					Program.cumulus.LogMessage("POWER: Detected system QUERY SUSPEND", Cumulus.LogLevel.Warning);
					break;
				case PowerBroadcastStatus.QuerySuspendFailed:
					Program.cumulus.LogMessage("POWER: Detected system QUERY SUSPEND FAILED");
					break;
				case PowerBroadcastStatus.ResumeAutomatic:
					Program.cumulus.LogMessage("POWER: Detected system RESUME AUTOMATIC", Cumulus.LogLevel.Warning);
					break;
				...
				case PowerBroadcastStatus.ResumeSuspend:
					Program.cumulus.LogMessage("POWER: Detected system RESUMING FROM STANDBY", Cumulus.LogLevel.Warning);
					break;
